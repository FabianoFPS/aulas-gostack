...
let ResetPasswordService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  return (0, _tsyringe.inject)('RgUsertokensRepository')(target, undefined, 1);
}, _dec4 = function (target, key) {
  return (0, _tsyringe.inject)('RgHashProvider')(target, undefined, 2);
  ...
  constructor(userRepository, userTokensRepository, hashProvider) {
  ...
  async execute({
    ...
    const compareDate = (0, _dateFns.addHours)(userToken.created_at, 2);
