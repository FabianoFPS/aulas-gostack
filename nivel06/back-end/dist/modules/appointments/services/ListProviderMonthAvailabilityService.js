...
let ListProviderMonthAvailabilityService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const numberOfDayInMonth = (0, _dateFns.getDaysInMonth)(new Date(year, month - 1));
    ...
    const availability = eachDayArray.map(day => {
      ...
      return {
        day,
        availability: (0, _dateFns.isAfter)(compareDate, new Date()) && appointmentsInDay.length < 10
      };
    });
    return availability;
  }
